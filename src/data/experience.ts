import type { GlassIconKind } from '../components/GlassIcon/GlassIcon';
...
export const experienceScenes: readonly { icon: GlassIconKind; title: string; description: string }[] = [
  { icon: 'card', title: '나를 소개하고.', description: '키오스크에서 사원증 발급과 사용자 연결로 체험을 시작하도록 설계합니다.' },
  { icon: 'mirror', title: '거울 앞에 서면.', description: '스마트 미러로 이동해, 연결된 사용자 정보와 공간 센싱을 바탕으로 상호작용을 준비합니다.' },
  { icon: 'voice', title: '대화로 이어지도록.', description: '목소리와 화면의 응답이 이어지고, 사용자 맥락에 맞춰 달라지는 경험을 목표로 합니다.' },
];
